...
// fileUplode 网站文件夹名。需更具体参照博客目录 line 19 20
//$config ['site_url'] ="localhost/fileUplode" line 22网站网址需更改
//
...
$config ['flash_dir'] = $_SERVER['DOCUMENT_ROOT']."/upload"; //上传flash文件地址 采用绝对地址 方便upload.php文件放在站内的任何位置 后面不加"/",上传的文件将放在网站根目录下的upload文件夹下  fileUplode 网站文件夹名。需更改
$config ['img_dir'] = $_SERVER['DOCUMENT_ROOT']."/upload"; //上传img文件地址 采用绝对地址 采用绝对地址 方便upload.php文件放在站内的任何位置 后面不加"/"，上传的文件将放在网站根目录下的upload文件夹下
$config ['site_url'] = "http://ourblog.sn"; //网站的网址 这与图片上传后的地址有关 最后不加"/" 可留空
//没有文件夹时则创建
